...
String cid=request.getParameter("cid");
          ...
          <h1>Welcome To : <%=name%></h1>      
           ...
           <center>
               <h3>Parts Change Details   <a href="SearchCarAction.jsp?cid=<%=cid%>">Back</a></h3>
               <table>
                   <tr>
                       
                       <th>Service</th><th>Engine oil</th> <th>Oil Filter</th>
                       <th>Air Filter</th> <th>Coolant</th>
                       <th>Fuel Filter</th>
                       <th>Service Charge</th>
                      <th>Spark Plug</th>
                      <th>Brake Clutch Oil</th>
                   </tr>     
                  <%
                  try{
                  String query="select * from partchange where carid='"+cid+"'";
