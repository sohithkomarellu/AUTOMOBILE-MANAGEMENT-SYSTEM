      ...
      <div id="main">
          <center>
            ...
            <table>
               ...
               <tr><th>Total Amount</th><td><input type="text" name="total" required=""></td></tr>
               <tr><th>Kms</th><td><input type="text" name="kms" required=""></td></tr>
                 <tr><th>Month</th><td><input type="text"  name="month" required=""></td></tr>                 
                <tr><th>Free/Paid</th><td><select name="FreeorPaid" required="">
                                         <option></option>
