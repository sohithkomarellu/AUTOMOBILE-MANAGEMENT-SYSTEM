...
String cid=request.getParameter("cid");
          ...
          <h1>Welcome To : <%=name%></h1>      
           ...
           <center>
               <h3>Service Details   <a href="SearchCarAction.jsp?cid=<%=cid%>">Back</a></h3>
               <table>
                   <tr>
                       
                       <th>Service</th><th>Total Amount</th> <th>KMs</th>
                       <th>Month</th> <th>Free/Paid</th>
                      
                   </tr>     
                  <%
                  try{
                  String query="select * from service where carid='"+cid+"'";
                 ResultSet r=Queries.getExecuteQuery(query);
                 while(r.next()){
                     %>
                     <td><%=r.getString("service")%></tD>
                      <td><%=r.getString("total")%></tD>
                      <td><%=r.getString("kms")%></tD>
                       <td><%=r.getString("month")%></tD>
                      <td><%=r.getString("freeorpaid")%></tD>
