...
String cid=request.getParameter("cid");
          ...
          <h1>Welcome To : <%=name%></h1>      
           ...
           <center>
               <h3>Pricing Details   <a href="SearchCarAction.jsp?cid=<%=cid%>">Back</a></h3>
               <table>
                   <tr>
                       
                       <th>Card Company</th><th>Car Variant</th> <th>Car Type</th>
                       <th>Showroom Price</th> <th>RTO & Others</th> <th>Insurance</th>
                        <th>Image</th>
                   </tr>     
                  <%
                  try{
                  String query="select * from pricing where cardid='"+cid+"'";
                 ...
                 while(r.next()){
                     ...
                     <td><%=r.getString("company")%></tD>
                      ...
                      <td><%=r.getString("type")%></tD>
                       <td><%=r.getString("showroomprice")%></tD>
                      <td><%=r.getString("rto")%></tD>
                      <td><%=r.getString("Insurance")%></tD>
                          <td><image src="view.jsp?id=<%=r.getString("cardid")%>" width="100" height="100"/></tD>
                     <%
                 }
