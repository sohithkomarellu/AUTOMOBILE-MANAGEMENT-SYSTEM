...
String mobile=(String)session.getAttribute("mobile");
          ...
          <h1>Welcome To : <%=name%></h1>      
           ...
           <center>
              ...
              <form action="AnalysisGraphAction.jsp" method="post">
          <table>
              <tr><td><select id="countrySelect" size="1" name="company" onchange="makeSubmenu(this.value)">
<option value="" disabled selected>Choose Company Name</option>
<option value="MARUTISUZUIKI">MARUTISUZUKI</option>
<option value="TATA">TATA</option>
<option value="KIA">KIA</option>
<option value="TOYOTA">TOYOTA</option>

                      </select></td></tr>
              <tr><td><select id="citySelect" size="1"  name="varient">
<option value="" disabled selected>Choose Variants</option>
<option></option>
</select></td></tr>
